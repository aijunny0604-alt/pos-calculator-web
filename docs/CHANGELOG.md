...
#### Gemini API 키 2개 + 모델 3개 자동 폴백 (TextAnalyze.jsx, AdminPage.jsx)
- 키 2개 × 모델 3개 = 6조합 순서대로 자동 시도 (최신 키 우선)
- 어떤 에러(429/403/expired)든 다음 키/모델로 자동 폴백
- AI 주문인식 + AI 입고 둘 다 적용
- 에러 메시지 자연어 변환 (429→"일일 사용량 초과", 403→"접근 권한 없음")
